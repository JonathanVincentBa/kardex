...
class AsignarController extends Component
{
    ...
    public function RemoveAll()
    {
        ...
        $this->emit("remove-all','Se revocarón todos los permisos al rol $role->name");
    }
    ...
    public function SyncAll()
    {
        ...
        $this->emit("sync-all','Se sincronisarón todos los permisos al rol $role->name");
    }
    ...
    public function SyncPermiso($state, $permisoName)
    {
        if ($this->role != 'Elegir') {
            ...
            $this->emit('permi-error','Elige un rol válido');
        }
    }
}
